...
- Fixed image height calculation in JSON dump visualization agent "GpuMemDumpVis.py" (#37, thanks @rbertin-aso).
- Added JSON Schema for JSON dump format - see file "agents\GpuMemDumpVis\GpuMemDump.schema.json".
